...
@section('sidebar-nav')
    ...
    <a href="{{ route('donor.donations.create') }}" class="sidebar-link">➕ <span>Upload Donasi</span></a>
    <a href="{{ route('donor.donations.index') }}" class="sidebar-link active">📦 <span>Donasi Saya</span></a>
@endsection
@section('content')
<div class="flex items-center justify-between mb-4">
    ...
    <a href="{{ route('donor.donations.create') }}" class="px-5 py-2 bg-indigo-600 text-white rounded-xl text-sm font-bold hover:bg-indigo-700 transition-colors">
        ➕ Upload Baru
    </a>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
    ...
    <div class="col-span-3 py-16 text-center">
        ...
        <a href="{{ route('donor.donations.create') }}" class="mt-3 inline-block text-indigo-600 font-semibold hover:underline">Upload donasi pertama Anda →</a>
    </div>
    @endforelse
</div>
