...
<body
    class="font-sans antialiased min-h-screen bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900 flex items-center justify-center p-4">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="px-8 py-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="password" type="password" name="password" required autocomplete="current-password"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition text-sm pr-12"
                                placeholder="••••••••">
                ...
                <p class="text-center text-sm text-slate-500 mt-6">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="text-indigo-600 font-semibold hover:underline">Daftar di
                        sini</a>
                </p>
                ...
                <div class="mt-6 p-4 bg-slate-50 rounded-xl text-xs text-slate-500">
                    ...
                    <p>User: user@kolektor.ac.id</p>
                    <p>User 1: user1@kolektor.ac.id</p>
